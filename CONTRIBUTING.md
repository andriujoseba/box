...
[heavy-duty/ceremony](https://github.com/heavy-duty/ceremony/blob/0.7.6/README.md).
Box pins the shared machinery and doctrine at `0.7.6`.
...
range (`sed -n '2,54p'`) rather than by a here-doc. So a line added above that
